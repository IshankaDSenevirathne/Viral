...
export default function Overview({user,cart}){
    ...
    return(     <div>
                    <div className="bg-white h-36 border-b border-gray-200 flex justify-start items-center p-5">
                        <p className="text-gray-800 container mx-auto font-bold text-4xl">Welcome, <span className="text-blue-500">{user.name || (user.firstName+ " " + user.lastName)}</span></p>
                        <div className="mr-5">
                    ...
                    <div className="hidden xl:grid px-2 w-full py-10">
                        <div className="grid md:grid-cols-1 lg:grid-cols-8 gap-2 w-full bg-gray-100 rounded-md my-2 min-h-screen">
                            <div  className="col-span-6 pt-5 shadow-md h-screen rounded-md bg-white">
                                {(liveCart && liveCart.length!=0)?
                                    <div  className="h-full flex flex-col">
                                        <div className="grow-0">
                                            <h1 className="text-gray-800 text-center pb-5 text-3xl font-bold ">Your Shopping Cart</h1>
                                        </div>
                                        <div className="grow flex flex-col">
                                            <div className=" grow m-5 rounded-md p-2 ">
                                                <div className="flex flex-col overflow-auto grid sm:grid-cols-1 md:grid-cols-5 gap-2 p-2">
                                            ...
                                            <div className="mt-5 border-t p-5 grow-0 rounded-b-md">
                                                <div className="w-full">
                                                    <div className="flex items-center justify-between text-center">
                                                        <p className="font-bold text-4xl text-gray-800">{parseFloat(totalPrice).toFixed(2)}<span className="text-blue-500 font-bold">$</span></p>
                                                        <div>
                                                            <button
                                                                onClick={handleEmptyCart}
                                                                type="button"
                                                                className="inline-flex m-1 px-5 justify-center rounded-md border border-gray-200 bg-gray-100  py-2 items-center text-md font-medium text-gray-800 hover:bg-white  focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 duration-300 delay-10"
                                                                >
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                className="inline-flex m-1 px-5 justify-center rounded-md bg-blue-500  py-2 items-center text-md font-medium text-white hover:bg-blue-400  focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 duration-300 delay-10"
                                                                >
                                                            ...
                                                            <button
                                                                type="button"
                                                                className="inline-flex m-1 px-5 justify-center rounded-md border border-transparent bg-green-500  py-2 items-center text-md font-medium text-white hover:bg-green-400  focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 duration-300 delay-10"
                            ...
                            <div className="col-span-2 h-screen rounded-md shadow-md bg-white">
                                <h1 className="text-blue-500 bg-gray-800 rounded-t-md text-center p-5 text-3xl font-bold ">Saved Orders</h1>
                                <div className="">
                                    {isLoadingSavedOrders || errorSavedOrders?
                                        <Spinner className="w-full"/>
                                            :
                                        <div  className="flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-white scrollbar-thumb-rounded max-h-152">
                                        {savedOrders && savedOrders.map((order,idx)=>(
                                            <div key={idx}>
                                            <div  className="bg-white text-gray-800 flex flex-col justify-between p-5 rounded-md">
                                                <div>
                                                                        ...
                                                                        <ul className="list-disc pl-5 ">
                                                                            <li>
                                                                                <span className="flex flex-col mb-1 ">
                                                                                    <p className="  p-1 mr-1 text-md font-semibold">
                                                                                        {product.productName}  
                                                                                    </p>
                                                                                    <div className="flex p-2 gap-2 text-sm bg-white rounded-md items-center">
                                                                                        <div className="bg-red-500 rounded-2xl w-3 h-3"></div>
                                                                                        <p className="">
                                                                                            &nbsp;{product.productSize}  
                                                                                        </p>
                                                                                        <p className="">
                                                ...
                                                <div className='flex flex-col w-full px-5 pt-5 text-right'>
                                                    <p className="font-bold text-gray-800 text-3xl">{order.orderDetails.totalPrice}<span className="text-blue-500">$</span></p>
                        ...
                        <div  className="bg-white p-5 rounded-md shadow-md">
                            <h1 className="text-gray-800 text-3xl font-bold mb-5">Latest Order</h1>
                            ...
                            <div className="mt-5">
                                <div className="flex flex-col w-full">
                                    <div className="grid grid-cols-8 text-center">
                                        <span className="bg-gray-800 p-2 mr-2 rounded-md">
                                            {ordersData && ordersData.data.length!=0 && <p className="text-gray-400 flex items-center justify-center font-bold text-sm ">{ordersData.data[ordersData.data.length-1].createdAt.substring(0,10)}</p>}
                                            {ordersData && ordersData.data.length!=0 && <p className="font-bold text-4xl text-white">{parseFloat(ordersData.data[ordersData.data.length-1].orderDetails.totalPrice*0.01).toFixed(2)}<span className="text-blue-500">$</span></p>}
                                        </span>
                                        <span className="bg-gray-800 p-2 rounded-md">{ordersData && ordersData.data.length!=0 && ordersData.data[ordersData.data.length-1].orderStatus=="Pending"?<span className="flex flex-col items-center justify-center"><p className="text-gray-400 flex items-center justify-start font-bold text-sm ">Getting Wrapped</p><GiftIcon className="h-10 w-10 text-yellow-500 " /></span>:<span className="flex flex-col items-center justify-center"><p className="text-gray-400 flex items-center justify-start font-bold text-sm ">Shipped</p><TruckIcon className="h-10 w-10 text-green-500 " /></span>}</span>
                                    </div>  
                                </div>
                            </div>
                        </div>
