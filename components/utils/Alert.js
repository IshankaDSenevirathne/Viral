...
function AlertWarning({isOpen,setIsOpen,info}){
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-end justify-end p-4 text-center">
                <Transition.Child
                  ...
                  leaveTo="opacity-0 scale-95"
                >
                  <Dialog.Panel className="relative border-2 border-yellow-500 w-full max-w-md transform overflow-hidden rounded-2xl bg-yellow-500 p-6 text-left align-middle shadow-xl transition-all">
                    <Dialog.Title
                      as="h3"
                      className="text-lg font-bold leading-6 text-white "
                    >
                    ...
                    <div className="mt-2">
                      ...
                      <button
                        type="button"
                        className="inline-flex justify-center rounded-md border border-transparent bg-yellow-700 px-4 py-2 mt-5 text-sm font-medium text-white hover:bg-yellow-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 focus-visible:ring-offset-2 duration-300 delay-10"
                        onClick={()=>setIsOpen(false)}
                      >
                        Got it, thanks!
                      </button>
...
export {AlertInfo,AlertSuccess,AlertWarning}